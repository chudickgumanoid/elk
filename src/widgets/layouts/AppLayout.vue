...
import ObserverNotification from "@/shared/UI/observer/ObserveNotification.vue";
import ObserverLoader from "@/shared/UI/observer/ObserverLoader.vue";
...
useHead({
  title: "Паспорт налогоплательщика",
});
